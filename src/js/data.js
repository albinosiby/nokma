...
export const INGREDIENTS = [
  ...
  { id: 'ageing', label: 'Ageing', img: 'flavour-vanilla', note: 'Resting the mix to develop body and a richer texture.' },
  { id: 'freezing', label: 'Freezing & Packaging', img: 'story-packaging', note: 'Freezing the mix and packing each product for sale.' },
